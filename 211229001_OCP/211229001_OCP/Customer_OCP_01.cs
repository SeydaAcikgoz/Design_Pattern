...
{
    public class Customer_OCP_01 : ITransactions_OCP_01
    {
        public int UserNo;
        ...
        public void ShowBasket()
        {
            ...
            Product.basket.ForEach(delegate (Products_OCP_01 products)
            {
            ...
            CustomerList.ForEach(delegate (Customer_OCP_01 customer)
            {
                if (customer.UserNo == UserCode)
                {
                    ...
                    if (customer.LoginStatus == true)
                    {
                        if (Product.basket.Count > 0)
                        {
                            Product.basket.ForEach(delegate (Products_OCP_01 product)
                            {
                                total += product.Price;
                            });
                        }
