...
{
    public class BronzCustomer_DI_01 : Customer_DI_01, ICustomerCategory_DI_01
    {
        public BronzCustomer_DI_01(int userno, string userName, string userSurname, string adress, double UserAmount, int point, string customerType, string email, string password, bool loginStatus)
        {
            this.UserNo = userno;
