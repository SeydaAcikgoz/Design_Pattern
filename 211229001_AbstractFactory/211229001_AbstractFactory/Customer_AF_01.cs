...
{
    public class Customer_AF_01:ICustomerTransactions_AF_01,IProductTransactions_AF_01
    {
        public int UserNo;
        ...
        public void ShowBasket()
        {
            ...
            Product.basket.ForEach(delegate (Products_AF_01 products)
            {
        ...
        public void IncreasePoints(Customer_AF_01 customer)
        {
            ...
            CustomerList.ForEach(delegate (Customer_AF_01 customer)
            {
                if (customer.UserNo == UserCode)
                {
                    ...
                    if (customer.LoginStatus == true)
                    {
                        if (Product.basket.Count > 0)
                        {
                            Product.basket.ForEach(delegate (Products_AF_01 product)
                            {
                                total += product.Price;
                            });
                        }
