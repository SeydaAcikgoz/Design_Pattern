...
namespace _211229001_DIP
{
    ...
    public class Products_DIP_01 : IProductsTransactions_DIP_01
    {
        public int Code;
        ...
        public List<Products_DIP_01> ProductsList = new List<Products_DIP_01>();
        public List<Products_DIP_01> basket = new List<Products_DIP_01>();

        public Products_DIP_01()
        {
        }

        public Products_DIP_01(int code, string ProductName, int CategoryNo, string category, int Stock, double Price)
        {
            this.Code = code;
        ...
        public void CreateProductList()
        {
            ...
            Products_DIP_01 product1 = new Beverages_DIP_01(101, "Chai", 1, "Beverages", 39, 18);
            ProductsList.Add(product1);
            Products_DIP_01 product2 = new Beverages_DIP_01(102, "Chang", 1, "Beverages", 17, 19);
            ProductsList.Add(product2);
            Products_DIP_01 product3 = new Beverages_DIP_01(103, "Guarana Fantastica", 1, "Beverages", 20, 4.5);
            ProductsList.Add(product3);
            Products_DIP_01 product4 = new Confections_DIP_01(201, "Konbu", 2, "Confections", 24, 6);
            ProductsList.Add(product4);
            Products_DIP_01 product5 = new Confections_DIP_01(202, "Pavlova", 2, "Confections", 29, 17.45);
            ProductsList.Add(product5);
            Products_DIP_01 product6 = new Confections_DIP_01(203, "Sir Rodney's Marmalade", 2, "Confections", 40, 81);
            ProductsList.Add(product6);
            Products_DIP_01 product7 = new GrainsCereals_DIP_01(301, "Ikura", 3, "GrainsCereals", 31, 31);
            ProductsList.Add(product7);
            Products_DIP_01 product8 = new GrainsCereals_DIP_01(302, "Tofu", 3, "GrainsCereals", 35, 25.25);
            ProductsList.Add(product8);
            Products_DIP_01 product9 = new GrainsCereals_DIP_01(303, "Tunnbröd", 3, "GrainsCereals", 61, 9);
        ...
        {
            bool product = false;
            ProductsList.ForEach(delegate (Products_DIP_01 products)
            {
        ...
        public void ShowBasket()
        {
            ...
            basket.ForEach(delegate (Products_DIP_01 products)
            {
