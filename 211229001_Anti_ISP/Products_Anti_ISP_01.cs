...
namespace _211229001_Anti_ISP
{
    ...
    public class Products_Anti_ISP_01 : ITranscations_Anti_ISP_01
    {
        ...
        public Products_Anti_ISP_01(int code, string ProductName, CategoryType categoryType, int Stock, double Price)
        {
            this.Code = code;
        ...
        public void ShowBasket()
        {
            ...
            basket.ForEach(delegate (Products_Anti_ISP_01 products)
            {
