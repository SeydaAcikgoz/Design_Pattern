...
namespace _211229001_Anti_LSP
{
    ...
    public class Products_Anti_LSP_01
    {
        ...
        public Products_Anti_LSP_01(int code, string ProductName, CategoryType categoryType, int Stock, double Price)
        {
            this.Code = code;
        ...
        public void LogOut(int UserNo, List<Customer_Anti_LSP_01> CustomerList)
        {
        ...
        public void ShowBasket()
        {
            ...
            basket.ForEach(delegate (Products_Anti_LSP_01 products)
            {
        ...
        public void ShowAccount(int Usercode, List<Customer_Anti_LSP_01> CustomerList)
        {
