...
{
    public class Products_OCP_01 : ITransactions_OCP_01
    {
        public int Code;
        ...
        public List<Products_OCP_01> ProductsList = new List<Products_OCP_01>();
        public List<Products_OCP_01> basket = new List<Products_OCP_01>();

        public Products_OCP_01()
        {
        }

        public Products_OCP_01(int code, string ProductName,int CategoryNo, string category, int Stock, double Price)
        {
            this.Code = code;
        ...
        public void CreateProductList()
        {
            ...
            Products_OCP_01 product3 = new Beverages_OCP_01(103, "Guarana Fantastica",1, "Beverages", 20, 4.5);
            ProductsList.Add(product3);
            Products_OCP_01 product4 = new Confections_OCP_01(201, "Konbu",2, "Confections", 24, 6);
            ProductsList.Add(product4);
            Products_OCP_01 product5 = new Confections_OCP_01(202, "Pavlova",2, "Confections", 29, 17.45);
            ProductsList.Add(product5);
            Products_OCP_01 product6 = new Confections_OCP_01(203, "Sir Rodney's Marmalade",2, "Confections", 40, 81);
            ProductsList.Add(product6);
            Products_OCP_01 product7 = new GrainsCereals_OCP_01(301, "Ikura",3, "GrainsCereals", 31, 31);
            ProductsList.Add(product7);
            Products_OCP_01 product8 = new GrainsCereals_OCP_01(302, "Tofu",3, "GrainsCereals", 35, 25.25);
        ...
        public void ShowBasket()
        {
            ...
            basket.ForEach(delegate (Products_OCP_01 products)
            {
