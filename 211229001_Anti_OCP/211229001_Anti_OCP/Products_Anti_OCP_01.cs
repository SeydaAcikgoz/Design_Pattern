...
namespace _211229001_Anti_OCP
{
    ...
    public class Products_Anti_OCP_01
    {
        ...
        public Products_Anti_OCP_01(int code, string ProductName, CategoryType categoryType, int Stock, double Price)
        {
            this.Code = code;
        ...
        public void LogIn(int cod, string email, string password, List<Customer_Anti_OCP_01> CustomerList)
        {
        ...
        public void LogOut(int UserNo, List<Customer_Anti_OCP_01> CustomerList)
        {
        ...
        public void ShowBasket()
        {
            ...
            basket.ForEach(delegate (Products_Anti_OCP_01 products)
            {
        ...
        public void ShowAccount(int Usercode, List<Customer_Anti_OCP_01> CustomerList)
        {
