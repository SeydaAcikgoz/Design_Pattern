...
namespace _211229001_SRP
{
    class Program
    {
        ...
        {
            Customer_SRP_01 customer = new Customer_SRP_01();
            Products_SRP_01 product = new Products_SRP_01();

            customer.CustomerList.Add(new BronzCustomer_SRP_01() { UserNo = 1, UserName = "Seyda", UserSurname = "Acikgoz", Adress = "Konya", UserAmount = 1230, Point = 15, customerType = "Bronz", Email = "seyda@gmail.com", Password = "123Seyda", LoginStatus = false });
